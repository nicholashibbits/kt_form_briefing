...
1. **[#114340](https://github.com/department-of-veterans-affairs/va.gov-team/issues/114340) Engines** — what's in the remaining 8/74 sub-issues, and which are blocking the frontend work? On the frontend, is the plan to split `686c-674/` into two `applications/` directories, or stay co-located and rely on chapter-level modularity?
2. **[#119718](https://github.com/department-of-veterans-affairs/va.gov-team/issues/119718) FDF pilot** — given the 4/27/2026 milestone has passed, what's the current go-live state? Is the JSON path live in production or still gated to staging? Who owns rollback?
3. **[#119026](https://github.com/department-of-veterans-affairs/va.gov-team/issues/119026) (closed `not_planned`)** — the package.json schema pin is still here at line 340. What replaced the build-time-GET approach for FDF schema distribution? Is the long-term plan still to leave it as a pinned NPM/git package, and if so, what was wrong with the original plan?
4. **[#108392](https://github.com/department-of-veterans-affairs/va.gov-team/issues/108392) (Phase 2)** — view-dependents README ([local copy](dependents/original-readmes/view-dependents.md)) confirms the embedded 0538 in `view-dependents/manage-dependents/` was never released because of accessibility issues with the progressive-disclosure pattern. *(README — partly answered: history and accessibility blocker.)* Open: which path forward — extend picklist ([#120229](https://github.com/department-of-veterans-affairs/va.gov-team/issues/120229) done), revive a digital 0538, or drop the embedded 0538 entirely?
5. **[#124480](https://github.com/department-of-veterans-affairs/va.gov-team/issues/124480) Other Causes off-ramps** — which of the five scenarios survived scope cuts? Are any deferred to RBPS/VBA permanently?
...
1. **[#120876](https://github.com/department-of-veterans-affairs/va.gov-team/issues/120876)** — what triggered the reopen? Has the OMB / Pension & Fiduciary Services PDF spec actually been finalized, or is the date still slipping toward Q4 2026? Need the source-of-truth SharePoint deck.
2. For [#120876](https://github.com/department-of-veterans-affairs/va.gov-team/issues/120876), will deprecated fields be removed from the JSON schema (breaking change) or just stop being rendered (additive)? That determines migration strategy.
...
1. **[#102564](https://github.com/department-of-veterans-affairs/va.gov-team/issues/102564)** — what's blocking the remaining 5/16 sub-issues? Have the OMB / VBA-side PDF revisions stabilized, or is the team still re-aligning fields on a moving target?
2. The disability-rating alert from [#121731](https://github.com/department-of-veterans-affairs/va.gov-team/issues/121731): README ([local copy](income-and-assets/original-readmes/527ez-pensions.md)) confirms purpose ("100% disability pays more than pension") and toggle name. *(README — partly answered: purpose.)* Open: is logging behind `pensionRatingAlertLoggingEnabled` (`featureFlagNames.json:252`) currently on in production? Are dismiss/ignore rates reviewed anywhere?
...
1. **[#121603](https://github.com/department-of-veterans-affairs/va.gov-team/issues/121603)** — who's actually owning this? The epic has no assignee. Which sub-issues are blocking go-live, and is there frontend work on the confirmation page or status flow that this team owns?
...
4. **[#114166](https://github.com/department-of-veterans-affairs/va.gov-team/issues/114166)** is at 93% with a 2026-05-31 due date. What's blocking the remaining 3 sub-issues? Will it land before or after the BPDS integration in [#121603](https://github.com/department-of-veterans-affairs/va.gov-team/issues/121603), and which migration order is canonical?

---

## 0969

1. **[#121601](https://github.com/department-of-veterans-affairs/va.gov-team/issues/121601)** — same as [#121603](https://github.com/department-of-veterans-affairs/va.gov-team/issues/121603): who owns it? Frontend changes during BPDS cutover (confirmation page, error handling)?
...
2. **[#108392](https://github.com/department-of-veterans-affairs/va.gov-team/issues/108392) Phase 2 — largely answered by the README.** The dependents-verification README ([local copy](dependents/original-readmes/dependents-verification.md)) states: *"The form itself does allow to remove spouse and child dependents, but our team opted to not duplicate the work that 686c-674 is doing. Additionally, Form 21-0538 doesn't allow removal of a dependent parent."* So removal lives in 686c (the picklist via [#120229](https://github.com/department-of-veterans-affairs/va.gov-team/issues/120229)), and 0538 stays declarative on purpose. *(README — answered: the 0538 is not the long-term home for removal.)* The remaining question for the team is narrower: what scope, if any, of [#108392](https://github.com/department-of-veterans-affairs/va.gov-team/issues/108392) still applies to the 0538 codebase, vs. is fully owned by the 686 picklist?
